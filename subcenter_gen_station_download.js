                    ...
                    if (results[0].cnt > 0) {
                        ...
                        connection.query('update node_user set transtag=-1',//+ tableName,
                            function (err, results, fields) {
                                ...
                                //当前文件名
                                var filename = './public/subcenterincome/' + tableName + '_' + config.local.node_id + '_' + stamp + '.data'
                                //新文件名
                                var filename1 = './public/subcenterstationdownload/' + tableName + '_' + config.local.node_id + '_' + stamp + '.data'
                                //新文件名
                                    ...
                                    function (err, results, fields) {
                                        ...
                                        connection.query(sql6,
                                            function (err, results, fields) {
                                                ...
                                                fs.writeFileSync(filename1, JSON.stringify(result))
