...
var getDownLoadVer = function (fileName) {
    var kk = fs.readdirSync('./public/stationcentergetdownload/version/')
    var rt = fileName+'.000'
    for (var item in kk) {
...
var senddata = function () {
    return new Promise(function(resv,reject) {
            ...
            const req = http.request(opt, function (res) {
                ...
                {
                    var fname = res.headers['content-disposition'].split('filename=')[1].replace(/\"/g,'')
                    server_filename='./public/stationgetdownload/' + fname
                    server_filename1='./public/stationgetdownload/version/' + fname
